  ...
  return (
    <main className="flex flex-col relative">
      <div className="bg main relative">
        <div className=" relative.min-h[65vh].h[70vh] px-4">
          <img
            src={estate_keys}
            alt=""
            className="opacity-50 absolute top-0 left-0 w-full h-[30rem] object-cover"
          />
          <div className="relative py-10 container mx-auto text-white flex flex-col justify-center h-full gap-2">
            ...
            <p className="text-base md:text-lg">
              We are always online and active foer you
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="relative px-4 -mt-10 z-20">
        <form className="bg-white mx-auto shad p-5 rounded-lg grid md:grid-cols-2 w-full max-w-screen-md gap-3 md:gap-5">
          ...
          <input
            type="email"
            placeholder="Edwinbrentford@gmail.com"
            required
            className="rounded-md border-2 border-slate-200 py-2 px-4 text-sm md:text-base outline-none hover:border-main"
          />
          ...
          <button
            type="submit"
            className="rounded-md bg-main text-orange-400 py-2 px-4 text-sm md:text-base outline-none md:col-span-2"
          >
            Send Message
          </button>
        </form>
