...
import FeaturedSlider from "../components/FeaturedSider";
    ...
    <main className="flex flex-col bg-white p-4">
      <section className="container mx-auto flex flex-col md:flex-row-reverse gap-4 md:gap-8 md:items-center">
        ...
        <aside className="flex-1 flex flex-col gap-3 py-5 md:py-10">
          <h2 className="text-slate-800 font-semibold text-2xl sm:text-3xl md:text-4xl leading-snug">
          ...
          <p className="text-slate-700 text-base sm:text-lg text-justify leading-relaxed">
            ...
            necessitatibus veniam eos minus repudiandae odio voluptas quibusdam
            aspernatur! Doloremque illum aperiam, itaque culpa ea veniam illo!
            Aspernatur soluta amet minus!
          </p>
            ...
            <div className="bg-white drop-shadow-xl hover:shadow-2xl rounded-md p-4 mt-4 flex items-center gap-4">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-slate-700 text-xs sm:text-sm text-justify leading-relaxed">
                  ...
                  Illum corrupti dolorum est nobis eaque velit?
                </p>
              </div>
            </div>
            <div className="bg-white drop-shadow-xl hover:shadow-2xl rounded-md p-4 mt-4 flex items-center gap-4">
      ...
      <section className="relative py-20 md:pt-40 px-4 to-slate-950 from-slate-700 bg-gradient-to-b -mx-4 mt-10">
        <img
          src={estate_home5}
          alt=""
          className="absolute top-0 left-0 w-full h-full object-cover object-bottom opacity-40"
        />
        <div className="relative z-5 container mx-auto flex flex-col md:flex-row md:justify-between gap-6 py-10 md:pt-20">
          <div className="relative">
            ...
            <h3 className="bg-white p-2 pr-6 pt-0 rounded-none rounded-br-md text-slate-700 text-lg sm:text-2xl font-semibold capitalize w-max">
              For you.
            </h3>
            ...
            <div className="grid gap-3 md:gap-5 grid-cols-2 md:grid-cols-3">
              {["Furniture", "Home", "Rent", "100%", "Brand", "Pool"].map(
                (el, i) => (
                  <div
                    key={i}
                    className="bg-slate-600 hover:bg-slate-700 text-white text-center py-1 px-4 rounded-[2rem] "
                  >
                    {el}
                  </div>
                )
      ...
      <section className="bg-[#f7faff] -mx-4 p-6">
        <div className="container mx-auto flex flex-col gap-6 py-10">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <Link
              to="/properties"
              className="py-2 px-8 md:px-10 w-max border border-solid border-slate-700 text-slate-700 text-sm md:text-base rounded-full"
            >
              See more
            </Link>
          </div>
